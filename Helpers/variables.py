...
_ENV_CONFIG = {
    "test": {
        ...
        "BOT_LOG_CHANNEL_ID": 1495688648446836850,
        ...
        "ERROR_CHANNEL_ID": 1495691528658616420,
...
MAIN_LOG_GUILD_ID = 1495688335262486729

# ---- Server Buckets (DEV included only in test mode) ----
PERSONAL_TEST_GUILD_ID = 1352901131977625631  # personal test server

if IS_TEST_MODE:
    TAQ_GUILD_IDS = list(set([TAQ_GUILD_ID, DEV_GUILD_ID, PERSONAL_TEST_GUILD_ID, MAIN_LOG_GUILD_ID]))
    EXEC_GUILD_IDS = list(set([EXEC_GUILD_ID, DEV_GUILD_ID, PERSONAL_TEST_GUILD_ID, MAIN_LOG_GUILD_ID]))
    ALL_GUILD_IDS = list(set([TAQ_GUILD_ID, EXEC_GUILD_ID, DEV_GUILD_ID, PERSONAL_TEST_GUILD_ID, MAIN_LOG_GUILD_ID]))
else:
    TAQ_GUILD_IDS = list(set([TAQ_GUILD_ID, MAIN_LOG_GUILD_ID]))
    EXEC_GUILD_IDS = list(set([EXEC_GUILD_ID, MAIN_LOG_GUILD_ID]))
    ALL_GUILD_IDS = list(set([TAQ_GUILD_ID, EXEC_GUILD_ID, MAIN_LOG_GUILD_ID]))
